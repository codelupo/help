...
| !soundboard <br/> !sb   | Play some audio from given list <br/> Template: !soundboard {audio_name} <br/> E.g. !soundboard meow, !sb 9000 <br/> Available audio_name: meow, wawa, 9000 | -500 | all |
